const S_Y_MINI_HOTPOT = {
    ...
    dishes: [
        ...
        options: {
            ...
            option2: {
                name: "Option (Choose at least 5)", choices:
                [
                     "Black Beef Tripe 大片毛肚 ($6.49)",
                     "Shrimp Paste 虾滑 ($6.49)",
                     "Snowflake Beef 雪花牛肉 ($6.49)",
                     "Pork Intestine 肥肠 ($6.49)",
                     "Fried Pork Shin 炸猪皮 ($6.49)",
                     "Seaweed 海带丝 ($4.49)",
                     "Wood Ear 东北黑木耳 ($4.49)",
                     ...
                     "Instant Noodle 公仔面 ($3.00)",
                     "Frozen Tofu 冻豆腐 ($4.49)",
                     "Sliced Lamb 羊肉卷 ($5.49)",
                     "Beef Tripe 草原毛肚 ($5.49)",
                     "Pork belly ($5.49)",
                     "Sesame Oil with Ingredients 油碟 ($2.00)",
                     "Dry Chili Seasoning 干碟 ($1.50)",
