...
const EditExistingOrder = () => {
  ...
  const imageMap = {
    ...
    '季北川': jiBeiChuanImage,
    'eetu': meeTuImage,
    '花小娇金汤花胶鸡': missFlowerHotpotImage,
    '牛大 NewDa Noodles': newDaNoodlesImage,
    '98K': ninetyEightKImage,
    '面缘': noodlesTimeImage,
    'Spice 24': spiceTwentyFourImage,
    'S&Y Mini HotPot 蜀世冒菜': syMiniHotpotImage,
    'Tasty Moment': tastyMomentImage,
    '雲吞佳': wontonGuyImage,
