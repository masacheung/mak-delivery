const TASTY_MOMENT = {
  ...
  dishes: [
    ...
    { id: 12, name: '鲜肉小笼包', price:9.95  },
    { id: 13, name: '丝瓜小笼包', price:10.50  },
    { id: 14, name: '蟹粉小笼包', price:12.90  },
    { id: 15, name: '香辣小笼包', price:12.50  },
    { id: 16, name: '三拼小笼包', price:12.95 },
    { id: 17, name: '生煎包', price:8.95  },
