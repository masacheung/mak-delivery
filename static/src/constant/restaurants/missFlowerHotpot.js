const MISS_FLOWER_HOTPOT = {
    ...
    dishes: [
        ...
        { id: 1147, name: "五花肉 Pork Belly", price: 6.99 },
        { id: 1148, name: "牛百叶 Beef Tripe", price: 6.99 },
        { id: 1149, name: "手打牛肉丸 Handmade Beef Balls", price: 8.99 },
        { id: 1150, name: "鹌鹑蛋 Quail Egg", price: 7.99 },
        { id: 1151, name: "和牛拼盘 Wagyu Beef Combo", price: 49.99 },
        { id: 1152, name: "澳洲和牛肋眼肉M8 Australia Wagyu Chuck Eye Roll", price: 18.99 },
        { id: 1153, name: "日本A5顶级鲜切和牛 Japanese A5 Premium Wagyu Beef", price: 49.99 },
        { id: 1154, name: "澳洲和牛短肋板M8 Australia Wagyu Short Plate", price: 12.99 },
        { id: 1155, name: "美国和牛牛小排 BMS9 America Wagyu Short Ribs", price: 16.99 },
        { id: 1156, name: "美国和牛牛小排 M9 Australia Wagyu Short Ribs", price: 26.99 },
        { id: 1157, name: "新西蘭羔羊肉 New Zealand Lamb ", price: 12.99 },
        { id: 1158, name: "秘制嫩滑鸡肉 Marinated Tender Chicken ", price: 24.99 },
